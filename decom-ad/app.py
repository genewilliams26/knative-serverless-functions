...
def decomJirafacts():
    ...
    ad_group = json_req['ad_group']
    server_name = json_req['server_name']
    # vsvr_host = json_req['vsvr_host']

    cmd = "ansible-playbook -i /home/<User>/.g/decom/decom-ad-inv.yml -e \"ad_group=" + ad_group + " server_name=" + server_name + "\" /home/<User>/.g/decom/decom-ad.yml"
